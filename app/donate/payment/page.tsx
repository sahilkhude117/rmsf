...
export default function(){
    ...
    const { userInfo ,customAmount, donationType ,campaign } = useSelector((state: RootState) => state.donation);
    ...
    const handlePayment = useCallback(async (order: any) => {
        ...
        razorpay.open();
            ...
            const donationId = await axios.post('/api/donation', donationDetails)
            ...
            try {
                const response = await axios.post('/api/payment/create', orderDetails );
            ...
            <div className="flex justify-center items-center m-10">
                <div className="flex m-20">
                    <button onClick={onDonate}
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="250" height="40" fill="#072654" viewBox="0 0 1896 401" id="razorpay">

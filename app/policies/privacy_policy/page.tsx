  ...
  return (
    <div className="pt-20 px-8 max-w-4xl mx-auto mt-20 mb-20">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Ramanlal Maniyar Smruti Foundation is located at:
        </p>
        <address className="not-italic mb-4">
          Ramanlal Maniyar Smruti Foundation
          <br />
          S.No.377/1B/02, Flat No. S-1 Near LIC Office, Gadhinglaj, Kolhapur
          <br />
          416502 Maharashtra , India
          <br />
          +91 9109602146
        </address>
        <p className="mb-4">
          It is Ramanlal Maniyar Smruti Foundation's policy to respect your
          ...
          >
            rmsfoundationindia.org
          </a>{' '}
          (hereinafter, "us", "we", or "rmsfoundationindia.org/"). We respect
          your privacy and are committed to protecting personally identifiable
          information you may provide us through the Website.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Certain visitors to Ramanlal Maniyar Smruti Foundation's websites
          choose to interact with Ramanlal Maniyar Smruti Foundation in ways
          that require us to gather personally-identifying information. For
          example, we ask visitors who leave a comment at{' '}
          <a
            href="https://rmsfoundationindia.org/"
            className="text-blue-500 underline"
          >
            https://rmsfoundationindia.org/
          </a>{' '}
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Although most changes are likely to be minor, Ramanlal Maniyar Smruti
          Foundation may change its Privacy Policy from time to time, and in its
          sole discretion. We encourage visitors to frequently check this page
          for any changes. Your continued use of this site after any change in

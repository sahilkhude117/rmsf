...
export default function(){
    return <div className="mt-10 mb-10">
            <ProgramTitle src="/images/white-bg.png" alt="Education" title="EDUCATION"/>
        ...
        {/* Bottom Section */}
        <div
            className="relative w-full text-black p-10"
        >
        {/* Title */}
        <h1
            className="text-2xl font-bold mb-8 animate-[fade-in_1s_ease-out]"
        >
            For the academic year of 2023-24, RMSF shall offer following Scholarships :
        </h1>

      {/* Subheading container */}
        <div className="w-full max-w-4xl space-y-5 ml-20">
            {/* Item A */}
        <div
          className="flex justify-between items-center bg-white bg-opacity-20 rounded-lg p-4 shadow-md backdrop-blur-md"
        >
          <h2 className="text-lg ">A. Scholarship for needy students for Engineering</h2>
          <p className="text-xl font-semibold">15 Nos</p>
        </div>
        ...
        <div
          className="flex justify-between items-center bg-white bg-opacity-20 rounded-lg p-4 shadow-md backdrop-blur-md "
        >
          <h2 className="text-lg">B. Scholarship for needy students from 9th to 12 th</h2>
          <p className="text-xl font-semibold">100 Nos</p>
        </div>
        ...
        <div
          className="flex justify-between items-center bg-white bg-opacity-20 rounded-lg p-4 shadow-md backdrop-blur-md"
        >
          <h2 className="text-lg">C. School material Distribution</h2>
          <p className="text-xl font-semibold">500 Nos</p>
        </div>
        </div>
        </div>

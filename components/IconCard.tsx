...
export const IconCard = ({title,content,src,alt,size,isButton,href}:{title:string;content:string;src:string;size:number,alt:string,isButton?:boolean;href?:any;}) => {
  ...
  useEffect(() => {
    ...
    return <div className="mb-20">
        ...
        <div className="text-center maz-w-4xl w-full font-bold pl-20 pr-20">{title}</div>

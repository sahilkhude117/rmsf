...
export default function HorizontalScroll() {
    ...
    return (
        <section ref={targetRef} className="relative h-[200vh] mb-10" id='certificates'>
            <div className="sticky top-10 bottom-20 flex h-[450px] items-center flex-col overflow-hidden">
                ...
                <motion.div style={{ x }} className="flex gap-10 h-60 w-200">
                    <HorizontalBox src='/images/animated/home/stamp.gif'
                    ...
                    />
                    <HorizontalBox src='/images/animated/home/certificate.gif'
                                   alt='PAN Card'
                                   content='PAN Card'
                                   href='/docs/PAN.pdf'
                    />
                    <HorizontalBox src='/images/animated/home/tax.gif'
                                   alt='Form 10 AC'
                                   content='Form 10 AC'
                                   href='/docs/form-10.pdf'
                    />
                    <HorizontalBox src='/images/animated/home/bank.gif'

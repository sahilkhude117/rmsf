...
const ThreeIconScroll = ({src1,src2,src3,alt1,alt2,alt3,size}:{src1:string;src2:string;src3:string;alt1:string;alt2:string;alt3:string;size:number}) => {
  ...
  return (
    <div className="w-full">
      ...
      <div ref={sectionRef} className="relative mt-20 flex justify-center items-center space-x-20">
        <motion.div
          style={{ y: yPosition }}
